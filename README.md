...
A Linux debugger for Linux users to easily download their hex files into their ARM Cortex devices.Built on pyOCD、Miniconda and stcgal, this project was born from the laziness of typing flash commands.
